...
import { deleteRecipe } from "@/app/actions/recipe-action"
import {
    Dialog,
    DialogContent,
    DialogDescription,
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="flex flex-col items-center">
                <DialogHeader>
                    <DialogTitle className="text-xl text-center">Supprimer une recette</DialogTitle>
                ...
                <DialogTrigger asChild>
                <form action={deleteRecipe.bind(null, el.id)}>
