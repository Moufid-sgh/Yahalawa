...
import { deleteCategoryTips } from "@/app/actions/categoryTips-action"
import {
    Dialog,
    DialogContent,
    DialogDescription,
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="flex flex-col items-center">
                <DialogHeader>
                    <DialogTitle className="text-2xl text-center">Supprimer catégorie</DialogTitle>
                ...
                <DialogTrigger asChild>
                    <form action={deleteCategoryTips.bind(null, el.id)}>
