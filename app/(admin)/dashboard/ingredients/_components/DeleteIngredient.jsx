...
import { deleteIngredient } from "@/app/actions/ingredient-action"
import {
    Dialog,
    DialogContent,
    DialogDescription,
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="flex flex-col items-center">
                <DialogHeader>
                    <DialogTitle className="text-2xl text-center">Supprimer ingredient</DialogTitle>
                ...
                <DialogTrigger asChild>
                    <form action={deleteIngredient.bind(null, el.id)}>
