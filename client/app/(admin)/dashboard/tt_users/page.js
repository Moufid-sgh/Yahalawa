  ...
  return (
    <div className={`${navExpanded ? 'ml-56' : 'ml-12'} mt-8 transition-all duration-500`}>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button className="green-btn">&#10009; Ajouter un utilisateur</button>
      </div>
                ...
                return (
                    <tbody key={i} className="bg-white text-sm divide-y divide-gray text-darkgray">
                      <tr>
                        ...
                        <td className="px-4 py-2">21693964054</td>
                        <td className="px-4 py-2 whitespace-nowrap flex flex-col space-y-2">
                          <button className='bg-gray font-semibold rounded-md py-1 px-2 w-32 hover:text-red duration-300'>Delete</button>
                        </td>
                      </tr>
                    </tbody>
                )
